...
CUresult CUDAAPI cuGetErrorName( CUresult error, const char * * pStr ) {
	...
	CUresult CUDAAPI (*REAL_cuGetErrorName) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGetErrorName");
...
CUresult CUDAAPI cuInit( unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuInit) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuInit");
...
CUresult CUDAAPI cuDriverGetVersion( int * driverVersion ) {
	...
	CUresult CUDAAPI (*REAL_cuDriverGetVersion) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDriverGetVersion");
...
CUresult CUDAAPI cuDeviceGet( CUdevice * device, int ordinal ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGet) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGet");
...
CUresult CUDAAPI cuDeviceGetCount( int * count ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetCount) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetCount");
...
CUresult CUDAAPI cuDeviceGetName( char * name, int len, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetName) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetName");
...
CUresult CUDAAPI cuDeviceTotalMem( size_t * bytes, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceTotalMem) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceTotalMem");
...
CUresult CUDAAPI cuDeviceGetAttribute( int * pi, CUdevice_attribute attrib, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetAttribute) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetAttribute");
...
CUresult CUDAAPI cuDeviceGetProperties( CUdevprop * prop, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetProperties) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetProperties");
...
CUresult CUDAAPI cuDeviceComputeCapability( int * major, int * minor, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceComputeCapability) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceComputeCapability");
...
CUresult CUDAAPI cuDevicePrimaryCtxRetain( CUcontext * pctx, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDevicePrimaryCtxRetain) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDevicePrimaryCtxRetain");
...
CUresult CUDAAPI cuDevicePrimaryCtxRelease( CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDevicePrimaryCtxRelease) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDevicePrimaryCtxRelease");
...
CUresult CUDAAPI cuDevicePrimaryCtxSetFlags( CUdevice dev, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuDevicePrimaryCtxSetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDevicePrimaryCtxSetFlags");
...
CUresult CUDAAPI cuDevicePrimaryCtxGetState( CUdevice dev, unsigned int * flags, int * active ) {
	...
	CUresult CUDAAPI (*REAL_cuDevicePrimaryCtxGetState) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDevicePrimaryCtxGetState");
...
CUresult CUDAAPI cuDevicePrimaryCtxReset( CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDevicePrimaryCtxReset) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDevicePrimaryCtxReset");
...
CUresult CUDAAPI cuCtxCreate( CUcontext * pctx, unsigned int flags, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxCreate");
...
CUresult CUDAAPI cuCtxDestroy( CUcontext ctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxDestroy");
...
CUresult CUDAAPI cuCtxPushCurrent( CUcontext ctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxPushCurrent) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxPushCurrent");
...
CUresult CUDAAPI cuCtxPopCurrent( CUcontext * pctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxPopCurrent) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxPopCurrent");
...
CUresult CUDAAPI cuCtxSetCurrent( CUcontext ctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxSetCurrent) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxSetCurrent");
...
CUresult CUDAAPI cuCtxGetCurrent( CUcontext * pctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetCurrent) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetCurrent");
...
CUresult CUDAAPI cuCtxGetDevice( CUdevice * device ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetDevice) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetDevice");
...
CUresult CUDAAPI cuCtxGetFlags( unsigned int * flags ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetFlags");
...
CUresult CUDAAPI cuCtxSynchronize( void  ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxSynchronize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxSynchronize");
...
CUresult CUDAAPI cuCtxSetLimit( CUlimit limit, size_t value ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxSetLimit) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxSetLimit");
...
CUresult CUDAAPI cuCtxGetLimit( size_t * pvalue, CUlimit limit ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetLimit) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetLimit");
...
CUresult CUDAAPI cuCtxGetCacheConfig( CUfunc_cache * pconfig ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetCacheConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetCacheConfig");
...
CUresult CUDAAPI cuCtxSetCacheConfig( CUfunc_cache config ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxSetCacheConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxSetCacheConfig");
...
CUresult CUDAAPI cuCtxGetSharedMemConfig( CUsharedconfig * pConfig ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetSharedMemConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetSharedMemConfig");
...
CUresult CUDAAPI cuCtxSetSharedMemConfig( CUsharedconfig config ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxSetSharedMemConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxSetSharedMemConfig");
...
CUresult CUDAAPI cuCtxGetApiVersion( CUcontext ctx, unsigned int * version ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetApiVersion) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetApiVersion");
...
CUresult CUDAAPI cuCtxGetStreamPriorityRange( int * leastPriority, int * greatestPriority ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxGetStreamPriorityRange) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxGetStreamPriorityRange");
...
CUresult CUDAAPI cuCtxAttach( CUcontext * pctx, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxAttach) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxAttach");
...
CUresult CUDAAPI cuCtxDetach( CUcontext ctx ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxDetach) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxDetach");
...
CUresult CUDAAPI cuModuleLoad( CUmodule * module, const char * fname ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleLoad) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleLoad");
...
CUresult CUDAAPI cuModuleLoadData( CUmodule * module, const void * image ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleLoadData) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleLoadData");
...
CUresult CUDAAPI cuModuleLoadDataEx( CUmodule * module, const void * image, unsigned int numOptions, CUjit_option * options, void * * optionValues ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleLoadDataEx) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleLoadDataEx");
...
CUresult CUDAAPI cuModuleLoadFatBinary( CUmodule * module, const void * fatCubin ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleLoadFatBinary) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleLoadFatBinary");
...
CUresult CUDAAPI cuModuleUnload( CUmodule hmod ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleUnload) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleUnload");
...
CUresult CUDAAPI cuModuleGetFunction( CUfunction * hfunc, CUmodule hmod, const char * name ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleGetFunction) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleGetFunction");
...
CUresult CUDAAPI cuModuleGetGlobal( CUdeviceptr * dptr, size_t * bytes, CUmodule hmod, const char * name ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleGetGlobal) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleGetGlobal");
...
CUresult CUDAAPI cuModuleGetTexRef( CUtexref * pTexRef, CUmodule hmod, const char * name ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleGetTexRef) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleGetTexRef");
...
CUresult CUDAAPI cuModuleGetSurfRef( CUsurfref * pSurfRef, CUmodule hmod, const char * name ) {
	...
	CUresult CUDAAPI (*REAL_cuModuleGetSurfRef) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuModuleGetSurfRef");
...
CUresult CUDAAPI cuLinkCreate( unsigned int numOptions, CUjit_option * options, void * * optionValues, CUlinkState * stateOut ) {
	...
	CUresult CUDAAPI (*REAL_cuLinkCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLinkCreate");
...
CUresult CUDAAPI cuLinkAddData( CUlinkState state, CUjitInputType type, void * data, size_t size, const char * name, unsigned int numOptions, CUjit_option * options, void * * optionValues ) {
	...
	CUresult CUDAAPI (*REAL_cuLinkAddData) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLinkAddData");
...
CUresult CUDAAPI cuLinkAddFile( CUlinkState state, CUjitInputType type, const char * path, unsigned int numOptions, CUjit_option * options, void * * optionValues ) {
	...
	CUresult CUDAAPI (*REAL_cuLinkAddFile) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLinkAddFile");
...
CUresult CUDAAPI cuLinkComplete( CUlinkState state, void * * cubinOut, size_t * sizeOut ) {
	...
	CUresult CUDAAPI (*REAL_cuLinkComplete) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLinkComplete");
...
CUresult CUDAAPI cuLinkDestroy( CUlinkState state ) {
	...
	CUresult CUDAAPI (*REAL_cuLinkDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLinkDestroy");
...
CUresult CUDAAPI cuMemGetInfo( size_t * free, size_t * total ) {
	...
	CUresult CUDAAPI (*REAL_cuMemGetInfo) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemGetInfo");
...
CUresult CUDAAPI cuMemAlloc( CUdeviceptr * dptr, size_t bytesize ) {
	...
	CUresult CUDAAPI (*REAL_cuMemAlloc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemAlloc");
...
CUresult CUDAAPI cuMemAllocPitch( CUdeviceptr * dptr, size_t * pPitch, size_t WidthInBytes, size_t Height, unsigned int ElementSizeBytes ) {
	...
	CUresult CUDAAPI (*REAL_cuMemAllocPitch) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemAllocPitch");
...
CUresult CUDAAPI cuMemFree( CUdeviceptr dptr ) {
	...
	CUresult CUDAAPI (*REAL_cuMemFree) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemFree");
...
CUresult CUDAAPI cuMemGetAddressRange( CUdeviceptr * pbase, size_t * psize, CUdeviceptr dptr ) {
	...
	CUresult CUDAAPI (*REAL_cuMemGetAddressRange) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemGetAddressRange");
...
CUresult CUDAAPI cuMemAllocHost( void * * pp, size_t bytesize ) {
	...
	CUresult CUDAAPI (*REAL_cuMemAllocHost) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemAllocHost");
...
CUresult CUDAAPI cuMemFreeHost( void * p ) {
	...
	CUresult CUDAAPI (*REAL_cuMemFreeHost) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemFreeHost");
...
CUresult CUDAAPI cuMemHostAlloc( void * * pp, size_t bytesize, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuMemHostAlloc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemHostAlloc");
...
CUresult CUDAAPI cuMemHostGetDevicePointer( CUdeviceptr * pdptr, void * p, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuMemHostGetDevicePointer) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemHostGetDevicePointer");
...
CUresult CUDAAPI cuMemHostGetFlags( unsigned int * pFlags, void * p ) {
	...
	CUresult CUDAAPI (*REAL_cuMemHostGetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemHostGetFlags");
...
CUresult CUDAAPI cuMemAllocManaged( CUdeviceptr * dptr, size_t bytesize, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuMemAllocManaged) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemAllocManaged");
...
CUresult CUDAAPI cuDeviceGetByPCIBusId( CUdevice * dev, const char * pciBusId ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetByPCIBusId) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetByPCIBusId");
...
CUresult CUDAAPI cuDeviceGetPCIBusId( char * pciBusId, int len, CUdevice dev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceGetPCIBusId) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceGetPCIBusId");
...
CUresult CUDAAPI cuIpcGetEventHandle( CUipcEventHandle * pHandle, CUevent event ) {
	...
	CUresult CUDAAPI (*REAL_cuIpcGetEventHandle) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuIpcGetEventHandle");
...
CUresult CUDAAPI cuIpcOpenEventHandle( CUevent * phEvent, CUipcEventHandle handle ) {
	...
	CUresult CUDAAPI (*REAL_cuIpcOpenEventHandle) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuIpcOpenEventHandle");
...
CUresult CUDAAPI cuIpcGetMemHandle( CUipcMemHandle * pHandle, CUdeviceptr dptr ) {
	...
	CUresult CUDAAPI (*REAL_cuIpcGetMemHandle) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuIpcGetMemHandle");
...
CUresult CUDAAPI cuIpcOpenMemHandle( CUdeviceptr * pdptr, CUipcMemHandle handle, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuIpcOpenMemHandle) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuIpcOpenMemHandle");
...
CUresult CUDAAPI cuIpcCloseMemHandle( CUdeviceptr dptr ) {
	...
	CUresult CUDAAPI (*REAL_cuIpcCloseMemHandle) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuIpcCloseMemHandle");
...
CUresult CUDAAPI cuMemHostRegister( void * p, size_t bytesize, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuMemHostRegister) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemHostRegister");
...
CUresult CUDAAPI cuMemHostUnregister( void * p ) {
	...
	CUresult CUDAAPI (*REAL_cuMemHostUnregister) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemHostUnregister");
...
CUresult CUDAAPI cuMemcpy( CUdeviceptr dst, CUdeviceptr src, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy");
...
CUresult CUDAAPI cuMemcpyPeer( CUdeviceptr dstDevice, CUcontext dstContext, CUdeviceptr srcDevice, CUcontext srcContext, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyPeer) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyPeer");
...
CUresult CUDAAPI cuMemcpyHtoD( CUdeviceptr dstDevice, const void * srcHost, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoD) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoD");
...
CUresult CUDAAPI cuMemcpyDtoH( void * dstHost, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoH) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoH");
...
CUresult CUDAAPI cuMemcpyDtoD( CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoD) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoD");
...
CUresult CUDAAPI cuMemcpyDtoA( CUarray dstArray, size_t dstOffset, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoA) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoA");
...
CUresult CUDAAPI cuMemcpyAtoD( CUdeviceptr dstDevice, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoD) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoD");
...
CUresult CUDAAPI cuMemcpyHtoA( CUarray dstArray, size_t dstOffset, const void * srcHost, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoA) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoA");
...
CUresult CUDAAPI cuMemcpyAtoH( void * dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoH) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoH");
...
CUresult CUDAAPI cuMemcpyAtoA( CUarray dstArray, size_t dstOffset, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoA) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoA");
...
CUresult CUDAAPI cuMemcpy2D( const CUDA_MEMCPY2D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2D) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2D");
...
CUresult CUDAAPI cuMemcpy2DUnaligned( const CUDA_MEMCPY2D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2DUnaligned) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2DUnaligned");
...
CUresult CUDAAPI cuMemcpy3D( const CUDA_MEMCPY3D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3D) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3D");
...
CUresult CUDAAPI cuMemcpy3DPeer( const CUDA_MEMCPY3D_PEER * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3DPeer) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3DPeer");
...
CUresult CUDAAPI cuMemcpyAsync( CUdeviceptr dst, CUdeviceptr src, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAsync");
...
CUresult CUDAAPI cuMemcpyPeerAsync( CUdeviceptr dstDevice, CUcontext dstContext, CUdeviceptr srcDevice, CUcontext srcContext, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyPeerAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyPeerAsync");
...
CUresult CUDAAPI cuMemcpyHtoDAsync( CUdeviceptr dstDevice, const void * srcHost, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoDAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoDAsync");
...
CUresult CUDAAPI cuMemcpyDtoHAsync( void * dstHost, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoHAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoHAsync");
...
CUresult CUDAAPI cuMemcpyDtoDAsync( CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoDAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoDAsync");
...
CUresult CUDAAPI cuMemcpyHtoAAsync( CUarray dstArray, size_t dstOffset, const void * srcHost, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoAAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoAAsync");
...
CUresult CUDAAPI cuMemcpyAtoHAsync( void * dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoHAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoHAsync");
...
CUresult CUDAAPI cuMemcpy2DAsync( const CUDA_MEMCPY2D * pCopy, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2DAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2DAsync");
...
CUresult CUDAAPI cuMemcpy3DAsync( const CUDA_MEMCPY3D * pCopy, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3DAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3DAsync");
...
CUresult CUDAAPI cuMemcpy3DPeerAsync( const CUDA_MEMCPY3D_PEER * pCopy, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3DPeerAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3DPeerAsync");
...
CUresult CUDAAPI cuMemsetD8( CUdeviceptr dstDevice, unsigned char uc, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD8) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD8");
...
CUresult CUDAAPI cuMemsetD16( CUdeviceptr dstDevice, unsigned short us, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD16) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD16");
...
CUresult CUDAAPI cuMemsetD32( CUdeviceptr dstDevice, unsigned int ui, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD32) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD32");
...
CUresult CUDAAPI cuMemsetD2D8( CUdeviceptr dstDevice, size_t dstPitch, unsigned char uc, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D8) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D8");
...
CUresult CUDAAPI cuMemsetD2D16( CUdeviceptr dstDevice, size_t dstPitch, unsigned short us, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D16) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D16");
...
CUresult CUDAAPI cuMemsetD2D32( CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D32) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D32");
...
CUresult CUDAAPI cuMemsetD8Async( CUdeviceptr dstDevice, unsigned char uc, size_t N, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD8Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD8Async");
...
CUresult CUDAAPI cuMemsetD16Async( CUdeviceptr dstDevice, unsigned short us, size_t N, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD16Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD16Async");
...
CUresult CUDAAPI cuMemsetD32Async( CUdeviceptr dstDevice, unsigned int ui, size_t N, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD32Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD32Async");
...
CUresult CUDAAPI cuMemsetD2D8Async( CUdeviceptr dstDevice, size_t dstPitch, unsigned char uc, size_t Width, size_t Height, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D8Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D8Async");
...
CUresult CUDAAPI cuMemsetD2D16Async( CUdeviceptr dstDevice, size_t dstPitch, unsigned short us, size_t Width, size_t Height, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D16Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D16Async");
...
CUresult CUDAAPI cuMemsetD2D32Async( CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D32Async) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D32Async");
...
CUresult CUDAAPI cuArrayCreate( CUarray * pHandle, const CUDA_ARRAY_DESCRIPTOR * pAllocateArray ) {
	...
	CUresult CUDAAPI (*REAL_cuArrayCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuArrayCreate");
...
CUresult CUDAAPI cuArrayGetDescriptor( CUDA_ARRAY_DESCRIPTOR * pArrayDescriptor, CUarray hArray ) {
	...
	CUresult CUDAAPI (*REAL_cuArrayGetDescriptor) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuArrayGetDescriptor");
...
CUresult CUDAAPI cuArrayDestroy( CUarray hArray ) {
	...
	CUresult CUDAAPI (*REAL_cuArrayDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuArrayDestroy");
...
CUresult CUDAAPI cuArray3DCreate( CUarray * pHandle, const CUDA_ARRAY3D_DESCRIPTOR * pAllocateArray ) {
	...
	CUresult CUDAAPI (*REAL_cuArray3DCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuArray3DCreate");
...
CUresult CUDAAPI cuArray3DGetDescriptor( CUDA_ARRAY3D_DESCRIPTOR * pArrayDescriptor, CUarray hArray ) {
	...
	CUresult CUDAAPI (*REAL_cuArray3DGetDescriptor) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuArray3DGetDescriptor");
...
CUresult CUDAAPI cuMipmappedArrayCreate( CUmipmappedArray * pHandle, const CUDA_ARRAY3D_DESCRIPTOR * pMipmappedArrayDesc, unsigned int numMipmapLevels ) {
	...
	CUresult CUDAAPI (*REAL_cuMipmappedArrayCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMipmappedArrayCreate");
...
CUresult CUDAAPI cuMipmappedArrayGetLevel( CUarray * pLevelArray, CUmipmappedArray hMipmappedArray, unsigned int level ) {
	...
	CUresult CUDAAPI (*REAL_cuMipmappedArrayGetLevel) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMipmappedArrayGetLevel");
...
CUresult CUDAAPI cuMipmappedArrayDestroy( CUmipmappedArray hMipmappedArray ) {
	...
	CUresult CUDAAPI (*REAL_cuMipmappedArrayDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMipmappedArrayDestroy");
...
CUresult CUDAAPI cuPointerGetAttribute( void * data, CUpointer_attribute attribute, CUdeviceptr ptr ) {
	...
	CUresult CUDAAPI (*REAL_cuPointerGetAttribute) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuPointerGetAttribute");
...
CUresult CUDAAPI cuPointerSetAttribute( const void * value, CUpointer_attribute attribute, CUdeviceptr ptr ) {
	...
	CUresult CUDAAPI (*REAL_cuPointerSetAttribute) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuPointerSetAttribute");
...
CUresult CUDAAPI cuPointerGetAttributes( unsigned int numAttributes, CUpointer_attribute * attributes, void * * data, CUdeviceptr ptr ) {
	...
	CUresult CUDAAPI (*REAL_cuPointerGetAttributes) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuPointerGetAttributes");
...
CUresult CUDAAPI cuStreamCreate( CUstream * phStream, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamCreate");
...
CUresult CUDAAPI cuStreamCreateWithPriority( CUstream * phStream, unsigned int flags, int priority ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamCreateWithPriority) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamCreateWithPriority");
...
CUresult CUDAAPI cuStreamGetPriority( CUstream hStream, int * priority ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamGetPriority) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamGetPriority");
...
CUresult CUDAAPI cuStreamGetFlags( CUstream hStream, unsigned int * flags ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamGetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamGetFlags");
...
CUresult CUDAAPI cuStreamWaitEvent( CUstream hStream, CUevent hEvent, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamWaitEvent) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamWaitEvent");
...
CUresult CUDAAPI cuStreamAddCallback( CUstream hStream, CUstreamCallback callback, void * userData, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamAddCallback) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamAddCallback");
...
CUresult CUDAAPI cuStreamAttachMemAsync( CUstream hStream, CUdeviceptr dptr, size_t length, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamAttachMemAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamAttachMemAsync");
...
CUresult CUDAAPI cuStreamQuery( CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamQuery) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamQuery");
...
CUresult CUDAAPI cuStreamSynchronize( CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamSynchronize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamSynchronize");
...
CUresult CUDAAPI cuStreamDestroy( CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuStreamDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuStreamDestroy");
...
CUresult CUDAAPI cuEventCreate( CUevent * phEvent, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuEventCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventCreate");
...
CUresult CUDAAPI cuEventRecord( CUevent hEvent, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuEventRecord) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventRecord");
...
CUresult CUDAAPI cuEventQuery( CUevent hEvent ) {
	...
	CUresult CUDAAPI (*REAL_cuEventQuery) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventQuery");
...
CUresult CUDAAPI cuEventSynchronize( CUevent hEvent ) {
	...
	CUresult CUDAAPI (*REAL_cuEventSynchronize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventSynchronize");
...
CUresult CUDAAPI cuEventDestroy( CUevent hEvent ) {
	...
	CUresult CUDAAPI (*REAL_cuEventDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventDestroy");
...
CUresult CUDAAPI cuEventElapsedTime( float * pMilliseconds, CUevent hStart, CUevent hEnd ) {
	...
	CUresult CUDAAPI (*REAL_cuEventElapsedTime) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuEventElapsedTime");
...
CUresult CUDAAPI cuFuncGetAttribute( int * pi, CUfunction_attribute attrib, CUfunction hfunc ) {
	...
	CUresult CUDAAPI (*REAL_cuFuncGetAttribute) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuFuncGetAttribute");
...
CUresult CUDAAPI cuFuncSetCacheConfig( CUfunction hfunc, CUfunc_cache config ) {
	...
	CUresult CUDAAPI (*REAL_cuFuncSetCacheConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuFuncSetCacheConfig");
...
CUresult CUDAAPI cuFuncSetSharedMemConfig( CUfunction hfunc, CUsharedconfig config ) {
	...
	CUresult CUDAAPI (*REAL_cuFuncSetSharedMemConfig) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuFuncSetSharedMemConfig");
...
CUresult CUDAAPI cuLaunchKernel( CUfunction f, unsigned int gridDimX, unsigned int gridDimY, unsigned int gridDimZ, unsigned int blockDimX, unsigned int blockDimY, unsigned int blockDimZ, unsigned int sharedMemBytes, CUstream hStream, void * * kernelParams, void * * extra ) {
	...
	CUresult CUDAAPI (*REAL_cuLaunchKernel) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLaunchKernel");
...
CUresult CUDAAPI cuFuncSetBlockShape( CUfunction hfunc, int x, int y, int z ) {
	...
	CUresult CUDAAPI (*REAL_cuFuncSetBlockShape) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuFuncSetBlockShape");
...
CUresult CUDAAPI cuFuncSetSharedSize( CUfunction hfunc, unsigned int bytes ) {
	...
	CUresult CUDAAPI (*REAL_cuFuncSetSharedSize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuFuncSetSharedSize");
...
CUresult CUDAAPI cuParamSetSize( CUfunction hfunc, unsigned int numbytes ) {
	...
	CUresult CUDAAPI (*REAL_cuParamSetSize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuParamSetSize");
...
CUresult CUDAAPI cuParamSeti( CUfunction hfunc, int offset, unsigned int value ) {
	...
	CUresult CUDAAPI (*REAL_cuParamSeti) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuParamSeti");
...
CUresult CUDAAPI cuParamSetf( CUfunction hfunc, int offset, float value ) {
	...
	CUresult CUDAAPI (*REAL_cuParamSetf) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuParamSetf");
...
CUresult CUDAAPI cuParamSetv( CUfunction hfunc, int offset, void * ptr, unsigned int numbytes ) {
	...
	CUresult CUDAAPI (*REAL_cuParamSetv) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuParamSetv");
...
CUresult CUDAAPI cuLaunch( CUfunction f ) {
	...
	CUresult CUDAAPI (*REAL_cuLaunch) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLaunch");
...
CUresult CUDAAPI cuLaunchGrid( CUfunction f, int grid_width, int grid_height ) {
	...
	CUresult CUDAAPI (*REAL_cuLaunchGrid) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLaunchGrid");
...
CUresult CUDAAPI cuLaunchGridAsync( CUfunction f, int grid_width, int grid_height, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuLaunchGridAsync) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuLaunchGridAsync");
...
CUresult CUDAAPI cuParamSetTexRef( CUfunction hfunc, int texunit, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuParamSetTexRef) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuParamSetTexRef");
...
CUresult CUDAAPI cuOccupancyMaxActiveBlocksPerMultiprocessor( int * numBlocks, CUfunction func, int blockSize, size_t dynamicSMemSize ) {
	...
	CUresult CUDAAPI (*REAL_cuOccupancyMaxActiveBlocksPerMultiprocessor) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuOccupancyMaxActiveBlocksPerMultiprocessor");
...
CUresult CUDAAPI cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags( int * numBlocks, CUfunction func, int blockSize, size_t dynamicSMemSize, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags");
...
CUresult CUDAAPI cuOccupancyMaxPotentialBlockSize( int * minGridSize, int * blockSize, CUfunction func, CUoccupancyB2DSize blockSizeToDynamicSMemSize, size_t dynamicSMemSize, int blockSizeLimit ) {
	...
	CUresult CUDAAPI (*REAL_cuOccupancyMaxPotentialBlockSize) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuOccupancyMaxPotentialBlockSize");
...
CUresult CUDAAPI cuOccupancyMaxPotentialBlockSizeWithFlags( int * minGridSize, int * blockSize, CUfunction func, CUoccupancyB2DSize blockSizeToDynamicSMemSize, size_t dynamicSMemSize, int blockSizeLimit, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuOccupancyMaxPotentialBlockSizeWithFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuOccupancyMaxPotentialBlockSizeWithFlags");
...
CUresult CUDAAPI cuTexRefSetArray( CUtexref hTexRef, CUarray hArray, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetArray");
...
CUresult CUDAAPI cuTexRefSetMipmappedArray( CUtexref hTexRef, CUmipmappedArray hMipmappedArray, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetMipmappedArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetMipmappedArray");
...
CUresult CUDAAPI cuTexRefSetAddress( size_t * ByteOffset, CUtexref hTexRef, CUdeviceptr dptr, size_t bytes ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetAddress) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetAddress");
...
CUresult CUDAAPI cuTexRefSetAddress2D( CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR * desc, CUdeviceptr dptr, size_t Pitch ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetAddress2D) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetAddress2D");
...
CUresult CUDAAPI cuTexRefSetFormat( CUtexref hTexRef, CUarray_format fmt, int NumPackedComponents ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetFormat) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetFormat");
...
CUresult CUDAAPI cuTexRefSetAddressMode( CUtexref hTexRef, int dim, CUaddress_mode am ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetAddressMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetAddressMode");
...
CUresult CUDAAPI cuTexRefSetFilterMode( CUtexref hTexRef, CUfilter_mode fm ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetFilterMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetFilterMode");
...
CUresult CUDAAPI cuTexRefSetMipmapFilterMode( CUtexref hTexRef, CUfilter_mode fm ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetMipmapFilterMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetMipmapFilterMode");
...
CUresult CUDAAPI cuTexRefSetMipmapLevelBias( CUtexref hTexRef, float bias ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetMipmapLevelBias) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetMipmapLevelBias");
...
CUresult CUDAAPI cuTexRefSetMipmapLevelClamp( CUtexref hTexRef, float minMipmapLevelClamp, float maxMipmapLevelClamp ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetMipmapLevelClamp) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetMipmapLevelClamp");
...
CUresult CUDAAPI cuTexRefSetMaxAnisotropy( CUtexref hTexRef, unsigned int maxAniso ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetMaxAnisotropy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetMaxAnisotropy");
...
CUresult CUDAAPI cuTexRefSetFlags( CUtexref hTexRef, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetFlags");
...
CUresult CUDAAPI cuTexRefGetAddress( CUdeviceptr * pdptr, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetAddress) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetAddress");
...
CUresult CUDAAPI cuTexRefGetArray( CUarray * phArray, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetArray");
...
CUresult CUDAAPI cuTexRefGetMipmappedArray( CUmipmappedArray * phMipmappedArray, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetMipmappedArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetMipmappedArray");
...
CUresult CUDAAPI cuTexRefGetAddressMode( CUaddress_mode * pam, CUtexref hTexRef, int dim ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetAddressMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetAddressMode");
...
CUresult CUDAAPI cuTexRefGetFilterMode( CUfilter_mode * pfm, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetFilterMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetFilterMode");
...
CUresult CUDAAPI cuTexRefGetFormat( CUarray_format * pFormat, int * pNumChannels, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetFormat) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetFormat");
...
CUresult CUDAAPI cuTexRefGetMipmapFilterMode( CUfilter_mode * pfm, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetMipmapFilterMode) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetMipmapFilterMode");
...
CUresult CUDAAPI cuTexRefGetMipmapLevelBias( float * pbias, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetMipmapLevelBias) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetMipmapLevelBias");
...
CUresult CUDAAPI cuTexRefGetMipmapLevelClamp( float * pminMipmapLevelClamp, float * pmaxMipmapLevelClamp, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetMipmapLevelClamp) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetMipmapLevelClamp");
...
CUresult CUDAAPI cuTexRefGetMaxAnisotropy( int * pmaxAniso, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetMaxAnisotropy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetMaxAnisotropy");
...
CUresult CUDAAPI cuTexRefGetFlags( unsigned int * pFlags, CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefGetFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefGetFlags");
...
CUresult CUDAAPI cuTexRefCreate( CUtexref * pTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefCreate");
...
CUresult CUDAAPI cuTexRefDestroy( CUtexref hTexRef ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefDestroy");
...
CUresult CUDAAPI cuSurfRefSetArray( CUsurfref hSurfRef, CUarray hArray, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuSurfRefSetArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuSurfRefSetArray");
...
CUresult CUDAAPI cuSurfRefGetArray( CUarray * phArray, CUsurfref hSurfRef ) {
	...
	CUresult CUDAAPI (*REAL_cuSurfRefGetArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuSurfRefGetArray");
...
CUresult CUDAAPI cuTexObjectCreate( CUtexObject * pTexObject, const CUDA_RESOURCE_DESC * pResDesc, const CUDA_TEXTURE_DESC * pTexDesc, const CUDA_RESOURCE_VIEW_DESC * pResViewDesc ) {
	...
	CUresult CUDAAPI (*REAL_cuTexObjectCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexObjectCreate");
...
CUresult CUDAAPI cuTexObjectDestroy( CUtexObject texObject ) {
	...
	CUresult CUDAAPI (*REAL_cuTexObjectDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexObjectDestroy");
...
CUresult CUDAAPI cuTexObjectGetResourceDesc( CUDA_RESOURCE_DESC * pResDesc, CUtexObject texObject ) {
	...
	CUresult CUDAAPI (*REAL_cuTexObjectGetResourceDesc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexObjectGetResourceDesc");
...
CUresult CUDAAPI cuTexObjectGetTextureDesc( CUDA_TEXTURE_DESC * pTexDesc, CUtexObject texObject ) {
	...
	CUresult CUDAAPI (*REAL_cuTexObjectGetTextureDesc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexObjectGetTextureDesc");
...
CUresult CUDAAPI cuTexObjectGetResourceViewDesc( CUDA_RESOURCE_VIEW_DESC * pResViewDesc, CUtexObject texObject ) {
	...
	CUresult CUDAAPI (*REAL_cuTexObjectGetResourceViewDesc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexObjectGetResourceViewDesc");
...
CUresult CUDAAPI cuSurfObjectCreate( CUsurfObject * pSurfObject, const CUDA_RESOURCE_DESC * pResDesc ) {
	...
	CUresult CUDAAPI (*REAL_cuSurfObjectCreate) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuSurfObjectCreate");
...
CUresult CUDAAPI cuSurfObjectDestroy( CUsurfObject surfObject ) {
	...
	CUresult CUDAAPI (*REAL_cuSurfObjectDestroy) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuSurfObjectDestroy");
...
CUresult CUDAAPI cuSurfObjectGetResourceDesc( CUDA_RESOURCE_DESC * pResDesc, CUsurfObject surfObject ) {
	...
	CUresult CUDAAPI (*REAL_cuSurfObjectGetResourceDesc) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuSurfObjectGetResourceDesc");
...
CUresult CUDAAPI cuDeviceCanAccessPeer( int * canAccessPeer, CUdevice dev, CUdevice peerDev ) {
	...
	CUresult CUDAAPI (*REAL_cuDeviceCanAccessPeer) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuDeviceCanAccessPeer");
...
CUresult CUDAAPI cuCtxEnablePeerAccess( CUcontext peerContext, unsigned int Flags ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxEnablePeerAccess) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxEnablePeerAccess");
...
CUresult CUDAAPI cuCtxDisablePeerAccess( CUcontext peerContext ) {
	...
	CUresult CUDAAPI (*REAL_cuCtxDisablePeerAccess) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuCtxDisablePeerAccess");
...
CUresult CUDAAPI cuGraphicsUnregisterResource( CUgraphicsResource resource ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsUnregisterResource) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsUnregisterResource");
...
CUresult CUDAAPI cuGraphicsSubResourceGetMappedArray( CUarray * pArray, CUgraphicsResource resource, unsigned int arrayIndex, unsigned int mipLevel ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsSubResourceGetMappedArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsSubResourceGetMappedArray");
...
CUresult CUDAAPI cuGraphicsResourceGetMappedMipmappedArray( CUmipmappedArray * pMipmappedArray, CUgraphicsResource resource ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsResourceGetMappedMipmappedArray) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsResourceGetMappedMipmappedArray");
...
CUresult CUDAAPI cuGraphicsResourceGetMappedPointer( CUdeviceptr * pDevPtr, size_t * pSize, CUgraphicsResource resource ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsResourceGetMappedPointer) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsResourceGetMappedPointer");
...
CUresult CUDAAPI cuGraphicsResourceSetMapFlags( CUgraphicsResource resource, unsigned int flags ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsResourceSetMapFlags) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsResourceSetMapFlags");
...
CUresult CUDAAPI cuGraphicsMapResources( unsigned int count, CUgraphicsResource * resources, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsMapResources) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsMapResources");
...
CUresult CUDAAPI cuGraphicsUnmapResources( unsigned int count, CUgraphicsResource * resources, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuGraphicsUnmapResources) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGraphicsUnmapResources");
...
CUresult CUDAAPI cuGetExportTable( const void * * ppExportTable, const CUuuid * pExportTableId ) {
	...
	CUresult CUDAAPI (*REAL_cuGetExportTable) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuGetExportTable");
...
CUresult CUDAAPI cuTexRefSetAddress2D_v2( CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR * desc, CUdeviceptr dptr, size_t Pitch ) {
	...
	CUresult CUDAAPI (*REAL_cuTexRefSetAddress2D_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuTexRefSetAddress2D_v2");
...
CUresult CUDAAPI cuMemcpyHtoD_v2( CUdeviceptr dstDevice, const void * srcHost, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoD_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoD_v2");
...
CUresult CUDAAPI cuMemcpyDtoH_v2( void * dstHost, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoH_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoH_v2");
...
CUresult CUDAAPI cuMemcpyDtoD_v2( CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoD_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoD_v2");
...
CUresult CUDAAPI cuMemcpyDtoA_v2( CUarray dstArray, size_t dstOffset, CUdeviceptr srcDevice, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoA_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoA_v2");
...
CUresult CUDAAPI cuMemcpyAtoD_v2( CUdeviceptr dstDevice, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoD_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoD_v2");
...
CUresult CUDAAPI cuMemcpyHtoA_v2( CUarray dstArray, size_t dstOffset, const void * srcHost, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoA_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoA_v2");
...
CUresult CUDAAPI cuMemcpyAtoH_v2( void * dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoH_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoH_v2");
...
CUresult CUDAAPI cuMemcpyAtoA_v2( CUarray dstArray, size_t dstOffset, CUarray srcArray, size_t srcOffset, size_t ByteCount ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoA_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoA_v2");
...
CUresult CUDAAPI cuMemcpyHtoAAsync_v2( CUarray dstArray, size_t dstOffset, const void * srcHost, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoAAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoAAsync_v2");
...
CUresult CUDAAPI cuMemcpyAtoHAsync_v2( void * dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyAtoHAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyAtoHAsync_v2");
...
CUresult CUDAAPI cuMemcpy2D_v2( const CUDA_MEMCPY2D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2D_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2D_v2");
...
CUresult CUDAAPI cuMemcpy2DUnaligned_v2( const CUDA_MEMCPY2D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2DUnaligned_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2DUnaligned_v2");
...
CUresult CUDAAPI cuMemcpy3D_v2( const CUDA_MEMCPY3D * pCopy ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3D_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3D_v2");
...
CUresult CUDAAPI cuMemcpyHtoDAsync_v2( CUdeviceptr dstDevice, const void * srcHost, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyHtoDAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyHtoDAsync_v2");
...
CUresult CUDAAPI cuMemcpyDtoHAsync_v2( void * dstHost, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoHAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoHAsync_v2");
...
CUresult CUDAAPI cuMemcpyDtoDAsync_v2( CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpyDtoDAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpyDtoDAsync_v2");
...
CUresult CUDAAPI cuMemcpy2DAsync_v2( const CUDA_MEMCPY2D * pCopy, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy2DAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy2DAsync_v2");
...
CUresult CUDAAPI cuMemcpy3DAsync_v2( const CUDA_MEMCPY3D * pCopy, CUstream hStream ) {
	...
	CUresult CUDAAPI (*REAL_cuMemcpy3DAsync_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemcpy3DAsync_v2");
...
CUresult CUDAAPI cuMemsetD8_v2( CUdeviceptr dstDevice, unsigned char uc, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD8_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD8_v2");
...
CUresult CUDAAPI cuMemsetD16_v2( CUdeviceptr dstDevice, unsigned short us, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD16_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD16_v2");
...
CUresult CUDAAPI cuMemsetD32_v2( CUdeviceptr dstDevice, unsigned int ui, size_t N ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD32_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD32_v2");
...
CUresult CUDAAPI cuMemsetD2D8_v2( CUdeviceptr dstDevice, size_t dstPitch, unsigned char uc, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D8_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D8_v2");
...
CUresult CUDAAPI cuMemsetD2D16_v2( CUdeviceptr dstDevice, size_t dstPitch, unsigned short us, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D16_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D16_v2");
...
CUresult CUDAAPI cuMemsetD2D32_v2( CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height ) {
	...
	CUresult CUDAAPI (*REAL_cuMemsetD2D32_v2) = (CUresult CUDAAPI*)dlsym(RTLD_NEXT, "cuMemsetD2D32_v2");
