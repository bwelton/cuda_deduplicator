...
int main() {
	std::vector<const char *> synchMemoryCopies = {"cuMemcpyDtoH_v2","cuMemcpyHtoD_v2", "cuMemcpyHtoA_v2","cuMemcpyPeer"};
	std::vector<const char *> asyncMemoryCopies = {"cuMemcpyHtoDAsync_v2","cuMemcpyDtoHAsync_v2","cuMemcpyHtoAAsync_v2"};
	std::vector<const char *> knownSynch = {"cuMemAlloc_v2","cuMemFree_v2"}
