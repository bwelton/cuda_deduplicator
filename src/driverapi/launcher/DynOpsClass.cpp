...
bool DynOpsClass::IsNeverInstriment(BPatch_function * func) {
	static std::vector<std::string> librariesToSkip = {"xerces-c","libelf", "dyninst_10", "dyninst/build", "libessl", "dyninst/install","cudadedup-develop", "/opt/mellanox", "/usr/lib64/librt-", "spectrum-mpi", "ld-2.17", "libpthread-2.17.so"};
